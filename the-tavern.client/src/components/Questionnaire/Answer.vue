<template>
  ...
  <div class="col-md-6 col-12 px-4 py-md-4 py-2">
    <button type="button" class="btn btn-lg btn-primary shadow rounded font-xs w-100 text-shadow p-lg-2 p-md-3" @click="select(answerProp.value, state.activeQuestion.type)">
      {{ answerProp.body }}
    </button>
  </div>
</template>
